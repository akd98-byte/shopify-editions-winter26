...
void main() {
  ...
  // Color gradient
  vec3 color1 = vec3(0.482, 0.380, 1.0); // #7B61FF (accent-ai)
  vec3 color2 = vec3(0.039, 0.039, 0.039); // #0A0A0A (bg-primary)
  vec3 color3 = vec3(0.831, 0.686, 0.216); // #D4AF37 (accent-gold)
